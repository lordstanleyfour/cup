...
const characterActions = ["up", "right", "jump", "down right", "top right", "down"];
...
window.addEventListener("resize", function(){
    canvas.height = window.innerHeight;
    canvas.width = window.innerWidth; //resizes canvas and sprites properly if window resized during animation
})